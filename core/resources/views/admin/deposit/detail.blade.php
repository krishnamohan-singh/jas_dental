                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Doctor')
                            <span class="fw-bold">
                                <a href="{{ route('admin.doctor.detail', $deposit->doctor_id) }}">{{ @$deposit->doctor->name }}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Preferred Date')
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold">
                                @if (@$deposit->appointment->added_staff_id)
                                    <a href="{{route('admin.staff.detail', $deposit->appointment->staff->id)}}">{{ __(@$deposit->appointment->staff->name) }}</a>
                                        <br> <span class="text--small badge badge--primary">@lang('Staff')</span>
                                @elseif(@$deposit->appointment->added_assistant_id)
                                    <a href="{{route('admin.assistant.detail', $deposit->appointment->assistant->id)}}"> {{ __(@$deposit->appointment->assistant->name) }}</a>
                                    <br> <span class="text--small badge badge--dark">@lang('Assistant')</span>
                                @elseif(@$deposit->appointment->added_doctor_id)
                                    <a href="{{route('admin.doctor.detail', $deposit->appointment->doctor->id)}}"> {{ __(@$deposit->appointment->doctor->name) }}</a>
                        ...
                        @if($deposit->status == Status::PAYMENT_PENDING)
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    data-question="@lang('Are you sure to approve this payment?')"
