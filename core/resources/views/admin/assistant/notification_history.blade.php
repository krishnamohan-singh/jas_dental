                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <span class="fw-bold">{{ $log->assistant->name }}</span>
                                                <br>
                                            <span class="small">
                                                <a href="{{ route('admin.assistant.detail', $log->assistant) }}"><span>@</span>{{ $log->assistant->username }}</a>
                                            </span>
                                            @else
...
@push('breadcrumb-plugins')
    @if(@$assistant)
        <a href="{{ route('admin.assistant.notification.single',$assistant->id) }}" class="btn btn-outline--primary btn-sm"><i class="las la-paper-plane"></i> @lang('Send Notification')</a>
    @else
