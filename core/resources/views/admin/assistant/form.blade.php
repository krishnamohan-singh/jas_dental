                            ...
                            <div class="col-lg-4">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        :imagePath="getImage(getFilePath('assistantProfile') . '/' . @$assistant->image, getFileSize('assistantProfile'))"
                                        :size="getFileSize('assistantProfile')" class="w-100" id="uploadLogo" :required="false" />
