                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span class="small">
                                        <a
                                            href="{{ route('admin.doctor.detail', $log->doctor_id) }}"><span>@</span>{{ $log->doctor->username }}</a>
                                    </span>
                                    @elseif($log->staff)
                                    <span class="fw-bold">{{ $log->staff->name }}</span>
                                    <br>
                                    <span class="small">
                                        <a
                                            href="{{ route('admin.staff.detail', $log->staff_id) }}"><span>@</span>{{ $log->staff->username }}</a>
                                    </span>
                                    @elseif($log->assistant)
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        ...
                                        data-message="{{ $log->message }}" @if($log->image)
                                        data-image="{{asset(getFilePath('push').'/'.$log->image)}}" @endif @endif
