                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <span class="fw-bold">{{ $log->staff->name }}</span>
                                                <br>
                                            <span class="small">
                                                <a href="{{ route('admin.staff.detail', $log->staff_id) }}"><span>@</span>{{ $log->staff->username }}</a>
                                            </span>
                                            @else
...
@push('breadcrumb-plugins')
    @if(@$staff)
        <a href="{{ route('admin.staff.notification.single',$staff->id) }}" class="btn btn-outline--primary btn-sm"><i class="las la-paper-plane"></i> @lang('Send Notification')</a>
    @else
